...
int main(){
	...
	int horaIngreso, minIngreso, segIngreso, Casillas, Pos11, Pos22, Pos33, i, q, m, h, Op, Floor, Cont1, Cont2, Cont3, r, Cent,posValidar1[30], posValidar2[30], posValidar3[30];
	Casillas = 30;
	time_t now;
	struct tm nowLocal;
	now = time(NULL);
	...
	Piso2.Poner();
	Piso3.Poner();
	Slots Acum1(Casillas);
	Slots Acum2(Casillas);
	Slots Acum3(Casillas);
	...
	do
	{
		...
		switch(Op)
		{
			...
			case 2: cout<<"¿Qué piso desea ver? Digite 1, 2 o 3"<<endl;
					...
					system("cls");
					break;
			case 3: cout<<"Ingrese el piso que desee: \n";
					do
					{
						cout<<"Digite: ";
						cin>>Floor;
			...
			case 4: cout<<"Ingrese el piso que desee:\n";
					...
					if(Floor == 1)
					{
						...
						Piso1.DiferenciaTiempo(Pos11,Acum1);
						if(Cont1 == 1)
						{
							posValidar1[0] = 0;
							Cont1--;
					...
					else if(Floor == 2)
					{
						...
						Piso2.DiferenciaTiempo(Pos22,Acum2);
						if(Cont2 == 1)
						{
							posValidar2[0] = 0;
							Cont2--;
					...
					else if(Floor == 3)
					{
						...
						Piso3.DiferenciaTiempo(Pos33,Acum3);
						if(Cont3 == 1)
						{
							posValidar3[0] = 0;
							Cont3--;
